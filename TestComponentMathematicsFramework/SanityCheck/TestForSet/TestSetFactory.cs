...
public class TestSetFactory
{
    ...
    {
        var testSet2 = SetFactory.CreateSet<TestSetCustomElement,TestElement_Abstract_NonGeneric>(null);
        Assert.IsInstanceOfType<TestSetCustomElement>(testSet2);
        Assert.AreEqual(testSet2.innerMembers.Count,0);

        var testset3 = SetFactory.CreateSet<TestSet_Abstract_NonGeneric>(null);
    ...
    {
        var testSet2 = SetFactory.CreateSet<TestSetCustomElement,TestElement_Abstract_NonGeneric>(new TestElement_Abstract_NonGeneric());
        Assert.IsInstanceOfType<TestSetCustomElement>(testSet2);
        Assert.AreEqual(testSet2.innerMembers.Count,1);

        var testset3 = SetFactory.CreateSet<TestSet_Abstract_NonGeneric>(testSet2,1,"xyz");
        Assert.IsInstanceOfType<TestSet_Abstract_NonGeneric>(testset3);
